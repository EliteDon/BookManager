...
<tr>
<td><code>imgsAddress</code></td>
<td>图片地址[require('./images/1.jpg'), require('./images/2.jpg'), require('./images/3.jpg')]</td> 
</tr>
<tr>
...
<tr>
<td><code>imgsAddress</code></td>
<td>图片完成地址[require('./images/1.jpg'), require('./images/2.jpg'), require('./images/3.jpg')]</td> 
</tr>
<tr>
<td><code>imgSize</code></td>
<td>其中包含了width、height两个参数，分别代表图片的宽度和高度，支持百分比方式设置 如:{width:'100%',height:'200px'}。</td>
...
<html>
  <head>
    ...
    <script src="dist/vue-awesome-verify.min.js"></script>
    <link rel="stylesheet" href="dist/vue-awesome-verify.min.css">
    <title>vue-awesome-verify</title>
  </head>
  <body>
    <div id="app">
      <vue-awesome-verify type=1></vue-awesome-verify>
    </div>
  </body>
</html>
```
