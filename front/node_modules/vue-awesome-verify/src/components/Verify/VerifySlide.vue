    ...
    <div style="position: relative;"
        ...
        <div v-if="type ===  '2' "
            ...
            <div class="verify-img-panel"
                ...
                <div class="verify-refresh" style="z-index:3" @click.stop="refresh" v-show="showRefresh"><i class="iconfont icon-refresh"></i></div>
...
<script type="text/babel">
   ...
   * @description 滑块
   * */
  import {resetSize, isMobile} from '../../lib/util'
  export default {
    name: 'VerifySlide',
    props: {
      type: {
